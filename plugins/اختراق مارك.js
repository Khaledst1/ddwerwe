const handler = async (m, { conn, command, text }) => {
  ...
  const response = `⌘━━━━━━━⬣ *『🍷』* ⬣━━━━━━━⌘\n` +
    `*تم اختراقك بنجاح* ✅، ${text}   ${loveMessage}   *تم اختراقك بواسطة أبوهايف:♡ ملفاتك وبياناتك عند شات المطور*\n\n` +
    `*❥ بوت باتشيرا*\n` +
    `⌘━━━━━━━⬣ *『🍷』* ⬣━━━━━━━⌘`;
  ...
  async function loading() {
    const hawemod = [
      ...
      "*تم الاتصال بجهاز الضحية يتم تحميل البيانات* 《 ███████████▒▒▒▒▒》96%",
      "*اختراق الضحية 100% اكتمل جاري جمع جميع الأدلة* 《 ████████████▒▒▒▒》97%",
      "*اكتمل الاختراق* ✅ 《 ████████████████》100%",
