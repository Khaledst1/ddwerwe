let handler = async (m, { conn, args, usedPrefix, command }) => {
  ...
  const timestamp = new Date().toLocaleString('en-EG', { timeZone: 'Africa/Cairo' }); 
    ...
    viewOnceMessage: {
      message: {
        interactiveMessage: {
          ...
          body: {
            text: `*تاريخ ووقت الطلب:* ${timestamp}\n*افتح القائمة بواسطه الزر🔘*\n*اليك قائمه بقسم الاوامر وقسم المعلومات*📜\n*﹝❒═════﹝🍷﹞═════❒﹞*\n\n> *Copyright© 2024*.`
          },
          nativeFlowMessage: {
            buttons: [
              {
...
handler.help = ['info'];
handler.tags = ['main'];
handler.command = ['أوامر', 'a', 'الاوامر', 'ألاوامر', 'menu', 'Menu'];
