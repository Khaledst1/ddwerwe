...
global.db = new Low(/https?:\/\//.test(opts['db'] || 'mongodb+srv://Aurther:Aurther@testcluster.lkqw43l.mongodb.net/?retryWrites=true&w=majority') ? new cloudDBAdapter(opts['db']) : new JSONFile(`${opts._[0] ? opts._[0] + '_' : ''}database.json`));
